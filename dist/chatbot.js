import r2, { useState as t2 } from "react";
var g = { exports: {} }, h = {};
/**
 * @license React
...
function o2() {
  ...
  function u(m, n, l) {
    var p = null;
    if (l !== void 0 && (p = "" + l), n.key !== void 0 && (p = "" + n.key), "key" in n) {
      l = {};
      for (var _ in n)
        _ !== "key" && (l[_] = n[_]);
    } else l = n;
...
function a2() {
  return Y || (Y = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function j(e, r, t, o, E, k) {
      ...
      if (N.call(r, "key")) {
        a = i(e);
        var d = Object.keys(r).filter(function(e2) {
          return e2 !== "key";
        });
        o = 0 < d.length ? "{key: someKey, " + d.join(": ..., ") + ": ...}" : "{key: someKey}", M[a + o] || (d = 0 < d.length ? "{" + d.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    function A(e) {
      O(e) ? e._store && (e._store.validated = 1) : typeof e == "object" && e !== null && e.$$typeof === x && (e._payload.status === "fulfilled" ? O(e._payload.value) && e._payload.value._store && (e._payload.value._store.validated = 1) : e._store && (e._store.validated = 1));
    }
    function O(e) {
      return typeof e == "object" && e !== null && e.$$typeof === S;
    }
    var b = r2, S = Symbol.for("react.transitional.element"), W = Symbol.for("react.portal"), R = Symbol.for("react.fragment"), G = Symbol.for("react.strict_mode"), U = Symbol.for("react.profiler"), V = Symbol.for("react.consumer"), q = Symbol.for("react.context"), J = Symbol.for("react.forward_ref"), z = Symbol.for("react.suspense"), B = Symbol.for("react.suspense_list"), X = Symbol.for("react.memo"), x = Symbol.for("react.lazy"), H = Symbol.for("react.activity"), Q = Symbol.for("react.client.reference"), T = b.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, N = Object.prototype.hasOwnProperty, K = Array.isArray, w = console.createTask ? console.createTask : function() {
      return null;
    };
    b = {
    ...
    var P, C = {}, F = b.react_stack_bottom_frame.bind(
      b,
      l
    )(), I = w(m(l)), M = {};
    v.Fragment = R, v.jsx = function(e, r, t) {
...
var Z;
function c2() {
  return Z || (Z = 1, process.env.NODE_ENV === "production" ? g.exports = o2() : g.exports = a2()), g.exports;
}
var c = c2();
const n2 = "_app_18rh1_1", s2 = "_logoContainer_18rh1_9", l2 = "_logo_18rh1_9", i2 = "_logoReact_18rh1_27", u2 = "_title_18rh1_31", f2 = "_card_18rh1_38", d2 = "_button_18rh1_46", m2 = "_count_18rh1_68", p2 = "_description_18rh1_74", _2 = "_readTheDocs_18rh1_79", s = {
  app: n2,
  logoContainer: s2,
  logo: l2,
  logoReact: i2,
